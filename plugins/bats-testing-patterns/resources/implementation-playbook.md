...
setup() {
    ...
    source "${BATS_TEST_DIRNAME}/../cli-entry/script.sh"
}
...
setup() {
    ...
    export SCRIPT="${BATS_TEST_DIRNAME}/../cli-entry/script.sh"
}
...
@test "Script works in bash" {
    bash "${BATS_TEST_DIRNAME}/../cli-entry/script.sh" arg1
}

@test "Script works in sh (POSIX)" {
    sh "${BATS_TEST_DIRNAME}/../cli-entry/script.sh" arg1
}

@test "Script works in dash" {
    if command -v dash &>/dev/null; then
        dash "${BATS_TEST_DIRNAME}/../cli-entry/script.sh" arg1
    else
